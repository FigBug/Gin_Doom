...
static boolean I_Scale1x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
    int w = x2 - x1;
...
static boolean I_Scale2x(data_t* data, int x1, int y1, int x2, int y2)
{
...
static boolean I_Scale3x(data_t* data, int x1, int y1, int x2, int y2)
{
...
static boolean I_Scale4x(data_t* data, int x1, int y1, int x2, int y2)
{
...
static boolean I_Scale5x(data_t* data, int x1, int y1, int x2, int y2)
{
...
void I_ResetScaleTables(byte *palette)
{
    if (stretch_tables[0] != NULL)
    {
        free(stretch_tables[0]);
        free(stretch_tables[1]);
...
static boolean I_Stretch1x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean I_Stretch2x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean I_Stretch3x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean I_Stretch4x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean I_Stretch5x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
    ...
    if (M_CheckParm(data, "-scanline") > 0)
    {
...
static boolean I_Squash1x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean I_Squash2x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean I_Squash3x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean I_Squash4x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean I_Squash5x(data_t* data, int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
