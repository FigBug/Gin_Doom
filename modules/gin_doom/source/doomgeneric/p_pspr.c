...
void P_BringUpWeapon (data_t* data, player_t* player)
{
	...
	S_StartSound(data, player->mo, sfx_sawup);
...
{	
    ...
    {
	S_StartSound(data, player->mo, sfx_sawidl);
    }
  ...
  pspdef_t*	psp ) 
{
    ...
    P_SetPsprite (data, player,ps_flash,weaponinfo[player->readyweapon].flashstate);
}
  ...
  pspdef_t*	psp ) 
{
    ...
    S_StartSound(data, player->mo, sfx_sawhit);
...
( data_t* data,
  ...
  pspdef_t*	psp ) 
{
    S_StartSound(data, player->mo, sfx_pistol);
  ...
  pspdef_t*	psp ) 
{
    ...
    S_StartSound(data, player->mo, sfx_shotgn);
    P_SetMobjState (data, player->mo, S_PLAY_ATK2);
  ...
  pspdef_t*	psp ) 
{
    ...
    S_StartSound(data, player->mo, sfx_dshtgn);
    P_SetMobjState (data, player->mo, S_PLAY_ATK2);
...
( data_t* data,
  ...
  pspdef_t*	psp )
{
    S_StartSound(data, player->mo, sfx_bfg);
}
