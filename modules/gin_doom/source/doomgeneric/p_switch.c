...
void P_InitSwitchList(data_t* data)
{
    ...
    if (data->gamemode == registered || data->gamemode == retail)
	episode = 2;
    else
  ...
  int		time )
{
    ...
    I_Error(data, "P_StartButton: no button slots left!");
}
...
{               
	...
	if (EV_DoPlat(data, line,raiseAndChange,32))
		P_ChangeSwitchTexture(data, line,0);
	break;
	
      case 15:
	// Raise Floor 24 and change texture
	if (EV_DoPlat(data, line,raiseAndChange,24))
		P_ChangeSwitchTexture(data, line,0);
	break;
	
      case 18:
	// Raise Floor to next highest floor
	if (EV_DoFloor(data, line, raiseFloorToNearest))
		P_ChangeSwitchTexture(data, line,0);
	break;
	
      case 20:
	// Raise Plat next highest floor and change texture
	if (EV_DoPlat(data, line,raiseToNearestAndChange,0))
		P_ChangeSwitchTexture(data, line,0);
	break;
	
      case 21:
	// PlatDownWaitUpStay
	if (EV_DoPlat(data, line,downWaitUpStay,0))
		P_ChangeSwitchTexture(data, line,0);
	break;
	
      case 23:
	// Lower Floor to Lowest
	if (EV_DoFloor(data, line,lowerFloorToLowest))
		P_ChangeSwitchTexture(data, line,0);
	break;
	...
	break;
      ...
      case 71:
	// Turbo Lower Floor
	if (EV_DoFloor(data, line,turboLower))
		P_ChangeSwitchTexture(data, line,0);
	break;
	...
	break;
      ...
      case 55:
	// Raise Floor Crush
	if (EV_DoFloor(data, line,raiseFloorCrush))
		P_ChangeSwitchTexture(data, line,0);
	break;
	
      case 101:
	// Raise Floor
	if (EV_DoFloor(data, line,raiseFloor))
		P_ChangeSwitchTexture(data, line,0);
	break;
	
      case 102:
	// Lower Floor to Surrounding floor height
	if (EV_DoFloor(data, line,lowerFloor))
		P_ChangeSwitchTexture(data, line,0);
	break;
	...
	if (EV_DoPlat(data, line,blazeDWUS,0))
		P_ChangeSwitchTexture(data, line,0);
	break;
	...
	break;
      ...
      case 131:
	// Raise Floor Turbo
	if (EV_DoFloor(data, line,raiseFloorTurbo))
		P_ChangeSwitchTexture(data, line,0);
	break;
	...
	break;
      ...
      case 140:
	// Raise Floor 512
	if (EV_DoFloor(data, line,raiseFloor512))
		P_ChangeSwitchTexture(data, line,0);
	break;
	...
	break;
      ...
      case 62:
	// PlatDownWaitUpStay
	if (EV_DoPlat(data, line,downWaitUpStay,1))
		P_ChangeSwitchTexture(data, line,1);
	break;
