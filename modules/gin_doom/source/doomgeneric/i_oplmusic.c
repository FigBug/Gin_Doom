...
// ---------------------------------------------------------------------------
// Rendering entry point, called from the host audio thread by the per-
// instance DoomAudioEngine with the instance's music handle.
// ---------------------------------------------------------------------------

void DG_OPL_Render(void *music_handle, int16_t *buffer, unsigned int nsamples,
                   unsigned int rate)
{
    opl_music_t *m = (opl_music_t *) music_handle;
...
// This is the music module wired up in i_sound.c (InitMusicModule takes
// &DG_music_module).  It replaces the stubbed SDL music module.
